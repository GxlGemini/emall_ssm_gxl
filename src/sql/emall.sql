...
-- Records of carts
-- ----------------------------
INSERT INTO `carts` VALUES (2, 3, 5, 1);
INSERT INTO `carts` VALUES (3, 1, 10, 1);
INSERT INTO `carts` VALUES (4, 3, 3, 1);
INSERT INTO `carts` VALUES (5, 1, 6, 1);
...
INSERT INTO `goods` VALUES (6, '../upload/1-6.jpg', '栖霞苹果 爽脆清甜', '肉质紧密 味道甘甜', '约550g/2个', 9, 4, 12, '', 1);
...
CREATE TABLE `items`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单项' ROW_FORMAT = Dynamic;
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'user', 'R8FVKb/D6MgqaUITDhjuYQ==', '七哥宝宝宝宝宝宝宝', '123456789', '上海浦东新区');
